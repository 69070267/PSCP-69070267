...
```text
โจทย์บอกให้ทำกรอบข้อความที่รับค่าข้อความมา 5 ตัวโดยความยาวกรอบจะเพิ่มตามความยาวของตัวหนังสือที่ยาวที่สุดด้วย
```
...
```text
สร้าง list และรับ input เป็น for loop 5 รอบ และเมื่อรับ input ต้อง rstrip() ด้วย เพราะ testcase มีเกรียนใส่ space เยอะๆหลังคำอยู่ และเมื่อตัด space ออกแล้วจะสามารถทำการ len วัดระยะความยาวของประโยคได้ จึงสามารถทำให้กรอบยาวได้แล้ว และสำหรับตัวข้อความที่สั้น จะต้องใช้ ljust() เพื่อ fill ส่วนที่หายไป
```
...
```text
ใช้ตามที่คิดเลยเพราะว่าเมื่อ ljust ก็จะเติมได้เท่าความยาวเหมือนตัวที่ยาวที่สุดอยู่ดี
```
