...
```text
เข้าใจว่าโจทย์รับข้อมูลมาเป็นวันและเดือน โดยที่มีกฏว่า หากเป็นเดือนที่หาร 3 ลงตัว เมื่อผ่านวันที่ 21 ไป จะเลื่อนฤดูการทันที  ซึ่งจะเป็นกฏอย่างง่ายคือ ทุกๆ 3 เดือนหลังวันที่ 21 จะเร่งฤดูการต่อไปเสมอใน 9 วันสุดท้ายของเดือนที่หารด้วย 3 ลงตัว (3 , 6 , 9 , 12) ก่อนทำ if else จึงต้องทำ if หนึ่งตัวก็คือ เดือนหารลงตัวหรือไม่? ถ้าหารลงตัวจะต้อง month + 1 เพราะว่าเร่งให้ไปเดือนต่อไปเลย เพราะยังไงๆเดือนต่อไปก็จะเปลี่ยนฤดูการอยู่แล้ว
```
...
```text
ก่อนทำ if else จึงต้องทำ if หนึ่งตัวก็คือ เดือนหารลงตัวหรือไม่? ถ้าหารลงตัวจะต้อง month + 1 เพราะว่าเร่งให้ไปเดือนต่อไปเลย เพราะยังไงๆเดือนต่อไปก็จะเปลี่ยนฤดูการอยู่แล้ว
```
...
if not month % 3 :
        if days >= 21 and month:
            month += 1
และทำ if else ปกติ แต่ต้องทำเดือนที่ 13 ด้วย เพราะว่า 12 หาร 3 ลงตัว จึงจะเด้งไปเดือนที่ 13 ถ้าไม่ประกาศเดือน 13 ให้เป็น winter จะถือว่าไม่ถูกหลักการ
```
...
```text
กรณีที่เป็นเดือนที่หาร 3 ลงตัวก่อนวันที่ 21
```
...
```text
กรณีที่เป็นเดือนที่หาร 3 ลงตัวหลังวันที่ 21 
```
