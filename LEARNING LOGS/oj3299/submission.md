...
```text
เป็นการจำลองรูปแบบการปลูกดอกไม้ในตารางตามแนวทแยงโดยมีขนาดความหนาของแถบ = L และต้องการหาว่าช่องลำดับที่ N จะตกอยู่ในแถวไหน
```
...
```text
ต้องการหนดค่า 1 ตัวที่เป็นการบอกว่านี่คือแถบไหน และผมกำหนดให้เป็นตัว d เช่น d = 1 คือ แถบแรก และใน for loop จะทำ d += 1 เพราะว่าต้องการทำให้เป็นแถบที่ 2 ถ้ามี
```
...
```text
ใช้สูตรอนุกรมคำนวณความจุช่องรวมคือ (k * (k + 1)) // 2
```
