...
```text
โจทย์บอกให้ input จำนวน attempt ที่ต้อง loop มา และใน loop นั้น จะให้ใส่ค่าระหว่าง + กับ - 
โดย + = + 10 และ - = - 5
```
...
```text
รับค่ามาก่อนและทำ for loop นับ loop ตามจำนวนที่รับเข้า และใน loop เป็น if else + - ตามค่าที่ได้รับในแต่ละรอบ
```
