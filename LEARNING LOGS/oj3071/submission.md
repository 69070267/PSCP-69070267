...
```text
A ถึง B มีเลขอะไรบ้างที่หารด้วย d แล้วได้เศษ r 
```
...
```text
รับตัวแปร 4 ตัว  
ตัวแรกเป็นจำนวนเริ่ม
ตัวสองเป็นจำนวนสิ้นสุด
ตัวสามเป็นตัวหาร
ตัวสี่เป็นเศษที่หาได้
```
...
```text
ทำ for loop start : A , stop : B + 1 
และใน loop มี if   x   % d == r ให้ + 1 ใน ตัวแปรเลข
```
