...
```text
ทำเวลาเปิด ปิด ร้านค้าโดยที่มีหน่วยเป็นนาที
```
...
```text
ทำ for loop input เพื่อที่จะรับค่าได้หลายๆร้านค้า แยกเป็น map starp , stop โดยที่ต้อง +1 ไปทีละค่าด้วยจะได้นับได้เท่าเดิม โดยที่ร้านจะเปิดปิดตามเวลากำหนด
```
