...
```text
input ตัวอักษร
output ตัวอักษรเรียงจากหลังไปหน้าในตัวพิมพ์เล็กเท่านั้น
Constraints input เป็นตัวอักษรพิมพ์ใหญ่หรือเล็กก็ได้และจะเขียนมายังไงก็ได้ แต่ไม่ว่ายังไงก็ตาม output จะต้องออกมาเป็น ตัวพิมพ์เล็กและเรียงจากหลังไปหน้าเสมอ
```
...
Step 2 : print ออกมาโดยบังคับให้เป็น lower() และ นับจากหลังไปหน้า ([::-1])
```
...
```text
กรณีที่มีตัวอักษรเกิน 5 ตัว และมีตัวพิมพ์ใหญ่กลางข้อความ
```
