...
```text
เป็นคะแนนรีวิวโดยคะแนนแรก เป็น คะแนนของคนสามคนใน range ของ 0 - 10 ซึ่งผมกำหนดให้ว่า ถ้า คะแนน max และ min ห่างกันเกิน 2 คะแนน จะถูกนับว่าเป็นหน้าม้าแน่นอน เช่น max 8 แต่ คะแนนรวม 20 จะต้องนำมาหา min ของ คะแนนรวมนั้น หาได้จาก "คะแนนรวม - (2 * max)" เมื่อได้ min แล้ว ให้เอา max - min ได้เลย ซึ่งเขียนเป็น
if max - min > 2 :
print("Surprising")
else:
