...
```text
รับ input เป็น int บรรทัดแรกด้วย map เพราะต้องแยกสองตัวแปร
และต้องประกาศค่า pi จะได้ไม่คลาดเคลื่อน 
และต้องสร้าง list ก่อนทำ loop เพื่อที่จะเก็บข้อมูล input หลายๆตัวที่เรากำลังจะได้รับมาในการทำ loop input
วิธีการคำนวณ จะใช้ for loop รับ input แบบวนตามจำนวนผู้ประสบภัยที่ขอความช่วยเหลือเข้ามา
และต้องคำนวณภายใน loop หลัง input เลย โดยต้องหาพื้นที่วงกลลมจากการใช้ ( x^2 + y^2 ) * 3.1416
และถ้าจะหาเวลาจะต้องใช้สูตร พื้นที่วงกลม / ความเร็วที่หมึกจะกลืนกินพื้นที่ต่อวินาที (จาก input S อันแรก)
และเมื่อได้ผลลัพธ์แล้ว เราก็ append ผลลัพธ์เข้า list ที่เราเคยทำไว้ และ output print โดยการใช้ for (ตัวแปร) in (list) เพื่อที่จะพิมพ์ทีละตัว
```
...
```text
เมื่อใส่ตัวเลขไม่ครบ 2 ตัว (ขาดคนถาม)
```
