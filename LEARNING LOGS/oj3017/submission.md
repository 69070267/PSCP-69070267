...
```text
เข้าใจว่า ไม่ว่าจะสั่งอะไรจากทางร้านก็ตาม ร้านจะเก็บค่าธรรมเนียม 10% เสมอ และราคาค่าธรรมเนียมขั้นต่ำคือ 50 บาท ซึ่งจะเก็บค่าจำนวนโดยการนำราคามาคูณ 0.1 (10%) และจะมีเงื่อนไขหลายอย่าง และเมื่อบวกค่าธรรมเนียมไปแล้ว จะต้อง + vat อีก 7% (*0.07)
```
...
```text
ผมใช้ if else ในการหาค่าธรรมเนียม โดยที่ถ้า ราคา*ค่าบริการได้ต่ำกว่า 50 จะต้อง + ค่าบริการ 50 และค่าบริการที่สามารถ + ได้มากสุดคือไม่เกิน 1000 และในการสรุปราคาที่ต้องจ่ายจะต้องนำ ราคา = ราคา + (ราคา*0.07 (เพื่อนำมาหา vat ที่ + เพิ่ม) และระบุเป็นืศนิยม 2 ตำแหน่ง
```
...
```text
สุดท้ายก็ใช้ if else เหมือนเดิมเพราะใช้ได้จริง
```
...
```text
case ที่ ค่าบริการน้อยกว่า 50 บาท
```
