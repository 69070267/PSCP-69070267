...
```text
ต้องใช้อิฐก้อนใหญ่ให้ได้มากที่สุดก่อนจะใช้อิฐก้อนเล็กเสมอ ทำการลบจนกว่าผลต่างของ goal จะเท่ากับ 0
```
...
```text
รับค่า 3 ค่า
ทำคำนวณเป็น (b, goal // 5) (ใช้ // เพราะไม่สนเศษ จะได้จำนวนที่ใช้หิน b 
หาหินก้อนเล็กที่ต้องใช้โดยการ goal-(หินb * 5)
และทำการแสดงผลด้วยการ ทำ if else
```
