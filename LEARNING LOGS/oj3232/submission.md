...
```text
รับค่าสองตัว ค่าแรกคือระยะที่กบกระโดดได้ไกลที่สุด ค่าที่สองคือระยะทางที่ต้องทำให้ได้ โดยที่การที่กบจะกระโดดไปหลังจากรอบแรก แรงจะลดไป 2 หน่วย จึงต้องใช้ while loop หาว่าระยะทางน้อยกว่าระยะกระโดดถึงรึยัง
```
...
```text
ใช้ map รับค่าสองตัว และสร้างตัวแปรเลข 0 สองตัวไว้ใช้ใน while loop และ for loop
```
...
```text
ทำสมการใน while loop หาจำนวนครั้งการกระโดดให้ได้ ถ้าโดดไม่ถึงจะติด - และถ้ายังโดดได้อยู่ count จะ + 1 ไปเรื่อยๆ
```
