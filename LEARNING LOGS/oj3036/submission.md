...
```text
พังกำแพงกั้นห้องให้น้อยที่สุดเพื่อไต่จากห้องที่ input เข้ามา ไปยังห้องที่ 1
```
...
```text
เมื่อรับ n เข้ามา เราต้องหาชั้นก่อนโดยการใช้ square root N 
และคำนวณกำแพงโดยการเอา 2 * (ชั้น - 1)
และต้องเช็คด้วยว่าในห้องนั้นเป็นห้องที่ถูกล้อมเป็นสามเหลี่ยมหรือไม่โดยการให้ กำแพง - 1

เช่น input N = 21 = sqr 21 = math.ceil ได้ 5 
2 * ( 5 - 1 ) = 8 กำแพงที่ต้องพัง
 เช็ค ว่า ถ้า (5 +  21) %  2 แล้วได้เลขคี่ ก็จะ - ตัวเลือกที่ต้องพังกำแพงไปอีก 1 
```
