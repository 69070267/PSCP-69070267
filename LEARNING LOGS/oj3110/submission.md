...
```text
เป็นการคำนวณว่าต้นทางเป็นที่นี่แล้วปลายทางเป็นที่นี่จะมีค่าบริการเท่าไร
```
...
```text
รับ if else ถ้าชื่อสถานที่ตรงกับอะไร ก็บวกลบตามเงื่อนไขที่โจทย์ตั้งไว้
...
```text
รับค่าตรงๆ ทุกเงื่อนไขจะมี ค่าธรรมเนียมเริ่มต้น และ ค่าทำเนียมน้ำหนักแบบตั้งไว้แล้ว และ print output ออกมาแบบเอาแค่เศษ 2 ทศนิยม
```
