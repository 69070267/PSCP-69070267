...
```text
โจทย์ให้แปลงชื่อย่อของไพ่เป็นชื่อเต็มภาษาอังกฤษโดยต้องแยกส่วนแต้มและดอกจากชื่อย่อให้ถูกต้อง
```
...
```text
แยกส่วนแต้มและดอกให้ถูกต้องด้วยการ strip 
```
