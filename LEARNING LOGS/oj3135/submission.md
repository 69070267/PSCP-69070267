...
```text
โจทย์นี้คือการเล่นส่งของขวัญเป็นวงกลม โดยที่มีคน N คนนั่งเรียงกันเป็นวงกลมและระบุตำแหน่งโจรตามที่เรากำหนด ถ้าส่งบอลถึงโจรก็จบ หรือกลับมาหาคนแรก
```
...
```text
รับ input 3 ค่าเป็น map และใช้ if else และทำ while loop ใน if else
```
