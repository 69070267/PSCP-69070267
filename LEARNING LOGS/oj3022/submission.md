...
โปรแกรมให้รับ 3 ค่า
1.อุณหภูมิตั้งต้น
2.หน่วยอุณหภูมิตั้งต้น
3.อยากแปลงเป็นอุณหภูมิอะไร
ผมเห็นแบบนี้จึงรู้ว่าใช้ if else หาได้ง่ายๆ โดยใช้แค่ 
if (หน่วยแรก) เป็น ... (หน่วยสอง) เป็น ... : 
       ทำสูตรการแปลงหน่วยแรกเป็นหน่วยสองตามอุณหภูมิที่ใส่มา
เช่น celcius to farenheit สูตรคือ F = (อุณหภูมิตั้งต้น * 9/5) + 32
```
